...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="docs/ProtoBuf.html">ProtoBuf</a><a href="docs/ProtoBuf.Builder.html">.Builder</a>.</span>
...
<h4 class="name" id=".$type"><span class="type-signature">(static, non-null) </span>$type<span class="type-signature"> :<a href="docs/ProtoBuf.Reflect.Message.html">ProtoBuf.Reflect.Message</a></span></h4>
...
<span class="param-type"><a href="docs/ProtoBuf.Reflect.Message.html">ProtoBuf.Reflect.Message</a></span>
...
<h4 class="name" id="$type"><span class="type-signature">(non-null) </span>$type<span class="type-signature"> :<a href="docs/ProtoBuf.Reflect.Message.html">ProtoBuf.Reflect.Message</a></span></h4>
...
<dl class="details">
    ...
    <h4 class="name" id=".decode"><span class="type-signature">(static) </span>decode<span class="signature">(buffer, length<span class="signature-attributes">opt</span>, enc<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; (non-null) {<a href="docs/ProtoBuf.Builder.Message.html">ProtoBuf.Builder.Message</a>}</span></h4>
...
<dl class="details">
    ...
    <dd class="tag-see">
        <ul>
            <li><a href="docs/ProtoBuf.Builder.Message.html#.decode64">ProtoBuf.Builder.Message.decode64</a></li>
        
            <li><a href="docs/ProtoBuf.Builder.Message.html#.decodeHex">ProtoBuf.Builder.Message.decodeHex</a></li>
        </ul>
    </dd>
...
<span class="param-type"><a href="docs/ProtoBuf.Builder.Message.html">ProtoBuf.Builder.Message</a></span>
    ...
    <h4 class="name" id=".decode64"><span class="type-signature">(static) </span>decode64<span class="signature">(str)</span><span class="type-signature"> &rarr; (non-null) {<a href="docs/ProtoBuf.Builder.Message.html">ProtoBuf.Builder.Message</a>}</span></h4>
...
<span class="param-type"><a href="docs/ProtoBuf.Builder.Message.html">ProtoBuf.Builder.Message</a></span>
    ...
    <h4 class="name" id=".decodeDelimited"><span class="type-signature">(static) </span>decodeDelimited<span class="signature">(buffer, enc<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {<a href="docs/ProtoBuf.Builder.Message.html">ProtoBuf.Builder.Message</a>}</span></h4>
...
<span class="param-type"><a href="docs/ProtoBuf.Builder.Message.html">ProtoBuf.Builder.Message</a></span>
    ...
    <h4 class="name" id=".decodeHex"><span class="type-signature">(static) </span>decodeHex<span class="signature">(str)</span><span class="type-signature"> &rarr; (non-null) {<a href="docs/ProtoBuf.Builder.Message.html">ProtoBuf.Builder.Message</a>}</span></h4>
...
<span class="param-type"><a href="docs/ProtoBuf.Builder.Message.html">ProtoBuf.Builder.Message</a></span>
    ...
    <h4 class="name" id=".decodeJSON"><span class="type-signature">(static) </span>decodeJSON<span class="signature">(str)</span><span class="type-signature"> &rarr; (non-null) {<a href="docs/ProtoBuf.Builder.Message.html">ProtoBuf.Builder.Message</a>}</span></h4>
...
<span class="param-type"><a href="docs/ProtoBuf.Builder.Message.html">ProtoBuf.Builder.Message</a></span>
    ...
    <h4 class="name" id="$add"><span class="type-signature"></span>$add<span class="signature">(key, value, noAssert<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; (non-null) {<a href="docs/ProtoBuf.Builder.Message.html">ProtoBuf.Builder.Message</a>}</span></h4>
...
<div class="description">
    <p>Adds a value to a repeated field. This is an alias for <a href="docs/ProtoBuf.Builder.Message.html#add">ProtoBuf.Builder.Message#add</a>.</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-see">
        <ul>
            <li><a href="docs/ProtoBuf.Builder.Message.html#encode64">ProtoBuf.Builder.Message#encode64</a></li>
        
            <li><a href="docs/ProtoBuf.Builder.Message.html#encodeHex">ProtoBuf.Builder.Message#encodeHex</a></li>
        
            <li><a href="docs/ProtoBuf.Builder.Message.html#encodeAB">ProtoBuf.Builder.Message#encodeAB</a></li>
        </ul>
    </dd>
...
<div class="description">
    <p>Gets a field's value. This is an alias for <a href="docs/ProtoBuf.Builder.Message.html#$get">ProtoBuf.Builder.Message#$get</a>.</p>
</div>
...
<span class="param-type">*</span>
    ...
    <h4 class="name" id="set"><span class="type-signature"></span>set<span class="signature">(keyOrObj, value<span class="signature-attributes">opt</span>, noAssert<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; (non-null) {<a href="docs/ProtoBuf.Builder.Message.html">ProtoBuf.Builder.Message</a>}</span></h4>
...
<span class="param-type"><a href="docs/ProtoBuf.Builder.Message.html">ProtoBuf.Builder.Message</a></span>
    ...
    <h4 class="name" id="set%5BSomeField%5D"><span class="type-signature">(abstract) </span>set[SomeField]<span class="signature">(value, noAssert<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; (non-null) {<a href="docs/ProtoBuf.Builder.Message.html">ProtoBuf.Builder.Message</a>}</span></h4>
...
<span class="param-type"><a href="docs/ProtoBuf.Builder.Message.html">ProtoBuf.Builder.Message</a></span>
    ...
    <h4 class="name" id="set_%5Bsome_field%5D"><span class="type-signature">(abstract) </span>set_[some_field]<span class="signature">(value, noAssert<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; (non-null) {<a href="docs/ProtoBuf.Builder.Message.html">ProtoBuf.Builder.Message</a>}</span></h4>
...
<div class="description">
    <p>Returns the message as an ArrayBuffer. This is an alias for <a href="docs/ProtoBuf.Builder.Message.html#encodeAB">ProtoBuf.Builder.Message#encodeAB</a>.</p>
</div>
...
<div class="description">
    <p>Returns the message as a base64 encoded string. This is an alias for <a href="docs/ProtoBuf.Builder.Message.html#encode64">ProtoBuf.Builder.Message#encode64</a>.</p>
</div>
...
<div class="description">
    <p>Returns the message as a node Buffer. This is an alias for <a href="docs/ProtoBuf.Builder.Message.html#encodeNB">ProtoBuf.Builder.Message#encodeNB</a>.</p>
</div>
...
<div class="description">
    <p>Returns the message as a hex encoded string. This is an alias for <a href="docs/ProtoBuf.Builder.Message.html#encodeHex">ProtoBuf.Builder.Message#encodeHex</a>.</p>
</div>
...
<nav>
    <h2><a href="docs/index.html">Home</a></h2><h3>Classes</h3><ul><li><a href="docs/ProtoBuf.Builder.html">Builder</a></li><li><a href="docs/ProtoBuf.Builder.Message.html">Message</a></li><li><a href="docs/ProtoBuf.Builder.Service.html">Service</a></li><li><a href="docs/ProtoBuf.DotProto.Parser.html">Parser</a></li><li><a href="docs/ProtoBuf.DotProto.Tokenizer.html">Tokenizer</a></li><li><a href="docs/ProtoBuf.Map.html">Map</a></li><li><a href="docs/ProtoBuf.Reflect.Element.html">Element</a></li><li><a href="docs/ProtoBuf.Reflect.Enum.html">Enum</a></li><li><a href="docs/ProtoBuf.Reflect.Enum.Value.html">Value</a></li><li><a href="docs/ProtoBuf.Reflect.Extension.html">Extension</a></li><li><a href="docs/ProtoBuf.Reflect.Message.html">Message</a></li><li><a href="docs/ProtoBuf.Reflect.Message.ExtensionField.html">ExtensionField</a></li><li><a href="docs/ProtoBuf.Reflect.Message.Field.html">Field</a></li><li><a href="docs/ProtoBuf.Reflect.Message.OneOf.html">OneOf</a></li><li><a href="docs/ProtoBuf.Reflect.Namespace.html">Namespace</a></li><li><a href="docs/ProtoBuf.Reflect.Service.html">Service</a></li><li><a href="docs/ProtoBuf.Reflect.Service.Method.html">Method</a></li><li><a href="docs/ProtoBuf.Reflect.Service.RPCMethod.html">RPCMethod</a></li><li><a href="docs/ProtoBuf.Reflect.T.html">T</a></li></ul><h3>Namespaces</h3><ul><li><a href="docs/ProtoBuf.html">ProtoBuf</a></li><li><a href="docs/ProtoBuf.DotProto.html">DotProto</a></li><li><a href="docs/ProtoBuf.Reflect.html">Reflect</a></li><li><a href="docs/ProtoBuf.Util.html">Util</a></li></ul>
</nav>
