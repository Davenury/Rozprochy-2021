...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="docs/ProtoBuf.html">ProtoBuf</a>.</span>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        ...
        <dl>
            <dt><a href="docs/ProtoBuf.Builder.Message.html">Message</a></dt>
            <dd></dd>
        
            <dt><a href="docs/ProtoBuf.Builder.Service.html">Service</a></dt>
            <dd></dd>
        </dl>
...
<h4 class="name" id="ns"><span class="type-signature"></span>ns<span class="type-signature"> :<a href="docs/ProtoBuf.Reflect.Namespace.html">ProtoBuf.Reflect.Namespace</a></span></h4>
...
<h4 class="name" id="ptr"><span class="type-signature"></span>ptr<span class="type-signature"> :<a href="docs/ProtoBuf.Reflect.T.html">ProtoBuf.Reflect.T</a></span></h4>
...
<h4 class="name" id="result"><span class="type-signature"></span>result<span class="type-signature"> :Object.&lt;string, (<a href="docs/ProtoBuf.Builder.Message.html">ProtoBuf.Builder.Message</a>|Object)>|null</span></h4>
...
<span class="param-type">Object.&lt;string, (<a href="docs/ProtoBuf.Builder.Message.html">ProtoBuf.Builder.Message</a>|Object)></span>
|
...
<span class="param-type">boolean</span>
    ...
    <h4 class="name" id="%22import%22%5D"><span class="type-signature"></span>"import"]<span class="signature">(json, filename<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; (non-null) {<a href="docs/ProtoBuf.Builder.html">ProtoBuf.Builder</a>}</span></h4>
...
<span class="param-type"><a href="docs/ProtoBuf.Builder.html">ProtoBuf.Builder</a></span>
    ...
    <h4 class="name" id="build"><span class="type-signature"></span>build<span class="signature">(path<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {<a href="docs/ProtoBuf.Builder.Message.html">ProtoBuf.Builder.Message</a>|!Object.&lt;string, *>}</span></h4>
...
<span class="param-type">!Object.&lt;string, *></span>
    ...
    <h4 class="name" id="create"><span class="type-signature"></span>create<span class="signature">(defs<span class="signature-attributes">non-null</span>)</span><span class="type-signature"> &rarr; (non-null) {<a href="docs/ProtoBuf.Builder.html">ProtoBuf.Builder</a>}</span></h4>
...
<span class="param-type"><a href="docs/ProtoBuf.Builder.html">ProtoBuf.Builder</a></span>
    ...
    <h4 class="name" id="define"><span class="type-signature"></span>define<span class="signature">(namespace)</span><span class="type-signature"> &rarr; (non-null) {<a href="docs/ProtoBuf.Builder.html">ProtoBuf.Builder</a>}</span></h4>
...
<span class="param-type"><a href="docs/ProtoBuf.Builder.html">ProtoBuf.Builder</a></span>
    ...
    <h4 class="name" id="lookup"><span class="type-signature"></span>lookup<span class="signature">(path<span class="signature-attributes">opt</span>, excludeNonNamespace<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; (nullable) {<a href="docs/ProtoBuf.Reflect.T.html">ProtoBuf.Reflect.T</a>}</span></h4>
...
<div class="description">
    <p>Similar to <a href="docs/ProtoBuf.Builder.html#build">ProtoBuf.Builder#build</a>, but looks up the internal reflection descriptor.</p>
</div>
...
<span class="param-type"><a href="docs/ProtoBuf.Reflect.T.html">ProtoBuf.Reflect.T</a></span>
    ...
    <h4 class="name" id="reset"><span class="type-signature"></span>reset<span class="signature">()</span><span class="type-signature"> &rarr; (non-null) {<a href="docs/ProtoBuf.Builder.html">ProtoBuf.Builder</a>}</span></h4>
...
<span class="param-type"><a href="docs/ProtoBuf.Builder.html">ProtoBuf.Builder</a></span>
    ...
    <h4 class="name" id="resolveAll"><span class="type-signature"></span>resolveAll<span class="signature">()</span><span class="type-signature"> &rarr; (non-null) {<a href="docs/ProtoBuf.Builder.html">ProtoBuf.Builder</a>}</span></h4>
