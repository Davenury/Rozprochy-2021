...
var client = require('grpc/src/client.js');

var server = require('grpc/src/server.js');

var common = require('grpc/src/common.js');

var Metadata = require('grpc/src/metadata.js');

var grpc = require('grpc/src/grpc_extension');

var protobuf_js_5_common = require('grpc/src/protobuf_js_5_common');
var protobuf_js_6_common = require('grpc/src/protobuf_js_6_common');

var constants = require('grpc/src/constants.js');
...
exports.credentials = require('grpc/src/credentials.js');
