...
var ByteBufferBrowser = require("bytebuffer/dist/bytebuffer.min.js");
var ByteBufferBrowser_DataView = require("bytebuffer/dist/bytebuffer-dataview.min.js");
var pkg = require("bytebuffer/package.json");
...
function makeSuite(ByteBuffer) {
    ...
    suite.init = function(test) {
        test.ok(require("bytebuffer/index.js"));
